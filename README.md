...
- [x] Файл `/etc/fstab` успешно восстановлен. Результат см. на скриншоте 🖼️ ["backup restore.png"](https://github.com/kamil1403/otus_vagrant/blob/main/screenshots/otus_vagrant_1.png)
